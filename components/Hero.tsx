...
const Hero: React.FC<HeroProps> = ({ 
  ...
  return (
    <div id="section-calzado" className="relative min-h-screen w-full overflow-hidden flex flex-col bg-[#020202] pt-28 pb-12 transition-all duration-700 scroll-mt-28">
